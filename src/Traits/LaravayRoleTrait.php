...
trait LaravayRoleTrait
{
    use LaravayDynamicRelationTrait, LaravayEventsTrait;
     ...
     * @return void|bool
     */
    public static function bootLaravayRoleTrait()
    {
    ...
    {
        $cacheKey = 'laravay_permissions_for_role_' . $this->getKey();
    ...
    public function syncPermissions($permissions)
    {
        ...
        foreach ($permissions as $permission) {
            $mappedPermissions[] = LaravayHelper::getIdFor($permission, 'permission');
        }
        $changes = $this->permissions()->sync($mappedPermissions);
        $this->flushCache();
        $this->fireLaravayEvent("permission.synced", [$this, $changes]);
        return $this;
    }
    ...
    {
        $permission = LaravayHelper::getIdFor($permission, 'permission');
        $this->permissions()->attach($permission);
        $this->flushCache();
        $this->fireLaravayEvent("permission.attached", [$this, $permission]);
        return $this;
    }
    ...
    public function detachPermission($permission)
    {
        ...
        $this->flushCache();
        $this->fireLaravayEvent("permission.detached", [$this, $permission]);
        return $this;
    }
    ...
    {
        Cache::forget('laravay_permissions_for_role_' . $this->getKey());
    }
